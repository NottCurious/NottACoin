...
public class NottACoin {
    ...
    public static void main(String[] args) {
        ...
        genesisTransaction.outputs.add(new TransactionOutput(genesisTransaction.receipient, genesisTransaction.value, genesisTransaction.transactionId)); //manually add the Transactions Output
